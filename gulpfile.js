      ...
      return gbrowserify.bundle({
        ...
        transforms: [
          ...
          envify({
            ...
            CONFIG_API_BASE_HTTPS: process.env.CONFIG_API_BASE_HTTPS,
            CONFIG_ASSET_URL: process.env.CONFIG_ASSET_URL,
            CONFIG_ASSET_URL_HTTPS: process.env.CONFIG_ASSET_URL_HTTPS,
            CONFIG_CDN_URL: process.env.CONFIG_CDN_URL,
            CONFIG_FB_ID: process.env.CONFIG_FB_ID,
            CONFIG_IS_SANDBOX: process.env.CONFIG_IS_SANDBOX
          })
        ],
        bundler: {
