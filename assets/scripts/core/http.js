...
if (process.env.CONFIG_API_BASE) {
  let isHTTPS = document.location.protocol == 'https:'
  let u = url.parse(isHTTPS ? process.env.CONFIG_API_BASE_HTTPS : process.env.CONFIG_API_BASE)
...
export function fetch(pathname, options) {
  const opts = {
    credentials: 'include',
    headers: {
